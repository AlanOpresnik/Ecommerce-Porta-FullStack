...
const ProductsFeatured = ({ prod }) => {
    ...
    return (
        <div className="mr-2">
            ...
            <div className="flex  py-2 mt-6 border justify-between gap-6 shadow-md rounded-xl px-2 overflow-x-auto max-w-[600px] ">
                <div>
                    <img
                ...
                <div className="flex w-full flex-col items-center lg:flex-row lg:items-start">
                    ...
                    <div className="flex mt-2 lg:mt-0">
                        ...
                        <Tooltip title="Ver Producto" arrow>
                            <Button onClick={() => navigate(`/products/${prod.subcategoryId.category}/${prod.name.replace(/\s+/g, '-')}/${prod.subcategoryId.name.replace(/\s+/g, '-')}/${prod._id}`)} >
