...
const ModalCpDelte = ({ open, onClose, onConfirm, cpTitle }) => {
  return (
    <Modal
      open={open}
      onClose={onClose}
    ...
    >
      ...
      >
        ...
        <div>
          ...
          >
            ¿Deseas eliminar el Codigo postal:{" "}
            <p className="text-[#b29f87] text-md font-bold">{cpTitle}</p>?
          </Typography>
        </div>
